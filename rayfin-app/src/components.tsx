...
export function Worklist({
  ...
  // member<->keeper pair, so the evidence behind "measure logic differs" is one click away instead
  // of having to hunt the same pair down in the clusters view or the similarity map.
